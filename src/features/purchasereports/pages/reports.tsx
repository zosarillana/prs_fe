    ...
    try {
      ...
      autoTable(pdf, {
        ...
        didDrawPage: () => {
          ...
          const showingTo = Math.min(page * pageSize, data?.totalItems ?? 0);
          const totalItems = data?.totalItems ?? 0;

          pdf.setFont("helvetica", "normal");
          pdf.setFontSize(10);
          pdf.text(
            `Showing ${showingFrom}–${showingTo} of ${totalItems} | Page ${currentPage}/${totalPages} | ${new Date().toLocaleDateString()}`,
            pageWidth - margin,
            margin + logoHeight / 2,
